...
const checkPool = (type = [], status, rank) => {
    ...
    useEffect(() => {
        if (location?.state?.userId)
            getExamList()
    }, [search, page, location?.state?.userId])
            ...
            <table className="w-full whitespace-nowrap">
                <thead>
                    <tr className="h-16 w-full text-sm leading-none text-gray-800">
                        ...
                        <th className="font-normal text-left pl-12">Exam Name</th>
                        <th className="font-normal text-left pl-12">Exam Date</th>
                        <th className="font-normal text-left pl-16">Rank</th>
                        <th className="font-normal text-left pl-16">Joining Money</th>
                ...
                <tbody className="w-full">
                    {data && data?.length > 0 && data.map((member, index) => (
                        ...
                        >
                            ...
                            <td className="pl-4 cursor-pointer">
                                <p className="text-sm font-medium leading-none text-gray-800">
                                    {moment(new Date(member?.schedule)).format('LLL')}
                                </p>
                            </td>
